function im = ts_read_zarr(fileName, chunk_i, timepoint_i, channel_i, python_path)
...
zarr_data_py = ts_reader.ts_read_matlab(fileName, uint16(chunk_i), uint16(timepoint_i), uint16(channel_i));
